...
This project implements various parallelisation techniques for a wavefront algorithm applied to square matrices. Parallelization approaches using FastFlow, OpenMP and MPI were used, with tests performed on both a single multi-core machine and a cluster of multi-core machines. The aim of the project was to measure and compare the performance of each approach in terms of execution time, acceleration, efficiency and scalability.


## Directory Structure

* **include/**: Contains header files for the project.
* **results/**: Directory with the results of the executed tests.
...
* **test_cluster.sh**: Script for running automated tests on the cluster with a different number of nodes.
...
* **UTWavefrontMPIOMP.cpp**: Implementation of the UTWavefront algorithm using MPI and OMP for parallelisation on a cluster of machines.
...
* **UTWMPIOMP**: Executable generated for implementation with MPI and OpenMP.
